...
;entradas
#define	    LE_POT  	    PORTB,0
#define	    LE_SENSOR  	    PORTB,1 
#define	    L_HEATER  	    PORTB,2
#define	    D_HEATER  	    PORTB,3  
...
LACO_PRINCIPAL
    BTFSS   L_HEATER	    ;testa se a chave está acionada
    BSF	    HEATER	    ;HEATER = 1    
    BTFSS   D_HEATER	    ;testa se a chave está acionada
    BCF	    HEATER	    ;HEATER = 0     
    BTFSS   LE_POT	    ;testa se a chave está acionada
    BCF	    QUAL_CANAL	    ;QUAL_CANAL = 0
    BTFSS   LE_SENSOR	    ;testa se a chave está acionada
